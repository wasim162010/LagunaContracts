...
contract ERC20 is Context, Ownable,IERC20 {
    ...
    //all the tax will be transferred to this address
    ...
    function setTaxParams(uint newTaxRate) public onlyOwner {
        taxRate = newTaxRate;
    }
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        ...
        if (fee > 0) {
            ...
            //transaction initiator is paying the tax..
...
contract LagunaTaxableToken is  ERC20Burnable {
    constructor() ERC20("Luguna Taxable Token", "LTXT", 18) public {
